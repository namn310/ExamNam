            ...
            <li class="mb-1 group">
                <div class="w-full ">
                    ...
                    <Disclosure v-slot="{ open }">
                        ...
                        <ul class="pl-7 mt-2 group-[.selected]:block">
                    <li class="mb-4">
                        <RouterLink :to="{ name : 'cauhoi'}" class="text-gray-300 text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Danh sách câu hỏi</RouterLink>
                    </li> 
                    <li class="mb-4">
                        <RouterLink :to="{name : 'create-cauhoi'}" class="text-gray-300 text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Tạo câu hỏi</RouterLink>
                    </li> 
                    <!-- <li class="mb-4">
            ...
            <li class="mb-1 group">
                <div class="w-full ">
                    ...
                    <Disclosure v-slot="{ open }">
                        ...
                        <ul class="pl-7 mt-2 group-[.selected]:block">
                    <li class="mb-4">
                        <RouterLink :to="{ name : 'exams'}" class="text-gray-300 text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Danh sách bài kiểm tra</RouterLink>
                    </li> 
                    <li class="mb-4">

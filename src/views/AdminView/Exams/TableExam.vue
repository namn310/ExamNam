...
<template>
  <div class="text-[50px] text-center text-500">Danh sách bài kiểm tra</div>
  ...
  <div class="pt-8">
    <el-table :data="filterTableData">
      ...
      <el-table-column label="Tên bài kiểm tra" prop="title" align="center" />
      <el-table-column label="Lớp học" prop="class" align="center" />
      <el-table-column label="Mô tả" prop="description" align="center" />
      <el-table-column label="Thời gian làm bài" prop="duration" align="center" />
      <el-table-column label="Số lượng câu hỏi" prop="totalQuestion" align="center" />
      <el-table-column align="center">
        ...
        <template #default="scope">
          <el-button size="small" type="primary" plain>
            <RouterLink :to="`/admin/detail-exam/${scope.row.id}`"> Detail </RouterLink>
          </el-button>
          <el-button size="small">
            <RouterLink :to="`/admin/edit-exam/${scope.row.id}`"> Edit </RouterLink>
          </el-button>

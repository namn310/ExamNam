                    ...
                    <div class="col-md-9">
                        <div class="contentblock">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="result-stats-box">
                                            ...
                                            <div class="result-stats-item">
                                                ...
                                                <span class="result-stats-text"><strong>0:54:05</strong></span>
                                            </div>
                                        </div>
                                        <br>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="result-score-box">
                                                   <button class="btn btn-success btn-sm"><i class="fa-solid fa-check fa-lg" style="color: #fcfcfc;"></i></button>
                                                    <div class="result-score-icontext text-correct">Trả lời đúng</div>
                                                    <div class="result-score-text"><strong>50</strong></div>
                                            ...
                                            <div class="col">
                                                <div class="result-score-box">
                                                    ...
                                                    <div class="result-score-text"><strong>0</strong></div>
                                                    <div class="result-score-sub"><span>câu hỏi</span></div>
                                                </div>
                                            </div>
                                            <div class="col">
                            ...
                            <div class="alert alert-success">
                                ...
                                Tips: Khi xem chi tiết đáp án bạn nên chú ý những câu sai để sau không bị gặp lại lỗi sai tương tự.
                            </div>
                            <br>
                        </div>
                    </div>

              ...
              <div class="tab-pane active show" id="partcontent-9022" role="tabpanel" aria-labelledby="pills-tab">
                ...
                <div class="test-questions-wrapper" v-for="( question, index) in questions" :key=" index ">
                  <div class="question-wrapper" data-qid="144565" id="question-wrapper-144565">
                    <div class="d-flex">
                      <div class="question-number d-flex justify-content-center text-center" data-qid="144565" style="
                          width: 30px;
                          height: 30px;
                    ...
                    <div class="question-content text-highlightable">
                      <div class="question-answers">
                        ...
                        <div class="form-check">
                          <input @click="ToggleSelected( index, 'A' )" data-type="question-answer"
                            class="form-check-input" :data-qid=" 'question-' + index + 'A' " type="radio"
                            :name=" 'question-' + index + 'A' " :id=" 'question-' + index + 'A' "
                            :checked=" answerSelected[index] === getLable( 0 ) "
                             />
                          <label :class=" { 'text-danger': answerSelected[index] === getLable( 0 ) && answerSelected[index] !== correctAnswer[index], 'text-success': correctAnswer[index] === getLable(0) } " class="form-check-label" :for=" 'question-' + index + 'A' ">
                        ...
                        <!-- Câu trả lời B -->
                        <div class="form-check">
                          <input @click="ToggleSelected( index, 'B' )" data-type="question-answer"
                            class="form-check-input" :data-qid=" 'question-' + index + 'B' " type="radio"
                            :name=" 'question-' + index + 'B' " :id=" 'question-' + index + 'B' "
                            :checked=" answerSelected[index] === getLable( 1 ) "
                             />
                          <label :class=" { 'text-danger': answerSelected[index] === getLable( 1 ) && answerSelected[index] !== correctAnswer[index] , 'text-success': correctAnswer[index] === getLable(1) } " class="form-check-label" :for=" 'question-' + index + 'B' ">
                        ...
                        <!-- Câu trả lời C -->
                        <div class="form-check">
                          <input @click="ToggleSelected( index, 'C' )" data-type="question-answer"
                            class="form-check-input" :data-qid=" 'question-' + index + 'C' " type="radio"
                            :name=" 'question-' + index + 'C' " :id=" 'question-' + index + 'C' "
                            :checked=" answerSelected[index] === getLable( 2 ) "
                             />
                          <label :class=" { 'text-danger': answerSelected[index] === getLable( 2 ) && answerSelected[index] !== correctAnswer[index] , 'text-success': correctAnswer[index] === getLable(2) } " class="form-check-label" :for=" 'question-' + index + 'C' " 
                        ...
                        <!-- Câu trả lời D -->
                        <div class="form-check">
                          <input @click="ToggleSelected( index, 'D' )" data-type="question-answer"
                            class="form-check-input" :data-qid=" 'question-' + index + 'D' " type="radio"
                            :name=" 'question-' + index + 'D' " :id=" 'question-' + index + 'D' "
                            :checked=" answerSelected[index] === getLable( 3 ) "
                            />
                          <label  :class=" { 'text-success': answerSelected[index] === getLable( 3 ) && answerSelected[index] !== correctAnswer[index],'text-success': correctAnswer[index] === getLable(3) } " class="form-check-label" :for=" 'question-' + index + 'D' ">

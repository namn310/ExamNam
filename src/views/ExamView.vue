                      ...
                      <!-- <div class="question-answers" v-for="( ANSWER, index2) in numberAnswer" :key=" index2 ">
                        <div class="form-check">
                          <input @click="ToggleSelected( index )" data-type="question-answer" class="form-check-input"
                            ...
                            :id=" 'question-' + index + ANSWER " :value=" getLable( index2 ) "
                            v-model=" answerSelected[index] " />
                          <label class="form-check-label" :for=" 'question-' + index + question.title ">{{
                            getLable(index2) }}.
                            {{ question.A }}.
                          </label>
                        </div>
            ...
            <div class="test-navigation__inner" id="test-navigation__inner">
              <div>
                <div class="timeleft-wrapper mb-2">
                  Thời gian còn lại:
                  <span data-totaltime="50.0" data-timeleft-value="48.766666666666666" id="timeleft" class="timeleft">{{
                    formatTime }}</span>
                </div>
